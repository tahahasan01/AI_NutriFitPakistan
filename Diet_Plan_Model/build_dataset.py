...
FOODS = [
    ...
    ("Naan", 50, 3, 5, 9, 2, "Bread", "Pakistani", "Breakfast"),
    ("Whole Wheat Roti", 46, 1, 4, 8, 6, "Bread", "Pakistani", "Breakfast"),
    ...
    ("Daal Masoor (cooked)", 20, 2, 1, 9, 8, "Legume", "Pakistani", "Lunch"),
    ...
    ("Chicken Qorma", 6, 2, 13, 14, 1, "Curry", "Pakistani", "Dinner"),
